...
public class ProjectionViewer extends Viewer {
    ...
    private void initComponents() {
        ...
        scalarToggleButton.setText("Color");
        ...
        edgesCoordToggleButton.setText("Edges");
    ...
    public class ViewPanel extends JPanel {
        ...
        public void paintComponent(java.awt.Graphics g) {
            ...
            if (graph != null && this.imageBuffer == null) {
                ...
                graph.draw(getCurrentConnectivity(), this.imageBuffer, highQualityRender);
                        ...
                        if (!ProjectionViewer.highlightTopic &&
                            ...
                            if (v != null) {
                                if (evt.getClickCount() == 1) {
                                    ...
                                    if (OpenDialog.checkCorpus(graph,
                                            pexview)) {
                                        MultipleFileView.getInstance(pexview).
                                                display(ProjectionViewer.this, v);
                                    }
                                }
                            }
