...
public class SimilarityMatrix extends javax.swing.JDialog {
    ...
    private ColorTable colorTable = new ColorTable(ColorScaleType.HEATEDOBJECTS);
    private ColorTable scaleTable = new ColorTable(ColorScaleType.PSEUDORAINBOWCALE);
