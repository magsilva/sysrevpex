...
public class DistanceMatrixFactory {
    ...
    public static DistanceMatrix getInstance(ProjectionView view, ProjectionData pdata) throws IOException {
        ...
        if (pdata.getDissimilarityType().equals(DissimilarityType.KOLMOGOROV)) {
        ...
        } else if (pdata.getSourceType().equals(SourceType.DISTANCE_MATRIX)) {
        ...
        Logger.getLogger(DistanceMatrixFactory.class.getName()).log(Level.INFO,
                "#Processing the distance matrix file: " + pdata.getSourceFile());
