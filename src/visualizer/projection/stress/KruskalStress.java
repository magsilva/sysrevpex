...
public class KruskalStress extends Stress {
    ...
    public static void main(String[] args) {
        try {
            ...
            if(args.length != 3){
                System.out.println("Usage: java KruskalStress <points> <projection> <dissimilarity>");
                System.out.println("   ex: java KruskalStress points.data projection.data cosine");
            }
