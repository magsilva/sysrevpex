...
public class NormalizedKruskalStress extends Stress {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (args.length != 3) {
                System.out.println("Usage: java NormalizedKruskalStress <points> <projection> <dissimilarity>");
                System.out.println("   ex: java NormalizedKruskalStress points.data projection.data cosine");
            }
            ...
            String msg = "Points: " + pointsfilename + "\r\n" +
                    "Projection: " + projfilename + "\r\n" +
            ...
            System.out.println("Kruskal stress: " + value);
            System.out.println("---");

        } catch (IOException ex) {
            Logger.getLogger(NormalizedKruskalStress.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
