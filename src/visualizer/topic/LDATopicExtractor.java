...
public class LDATopicExtractor {
    ...
    public LDATopicExtractor(Alphabet alphabet, SparseMatrix topic_documents_probabilites, ArrayList<TreeSet<IDSorter>> topic_words_probabilites) {
