 ...
 */
public class RegExpTermExtractor implements TermExtractor<String>
{
	    ...
	    public static String getRegularExpression() {
	        ...
	        String regex = m.getProperty("REG.EXPR");

	        if (regex == null || regex.trim().length() < 1) {
	            regex = "[0-9\\-]*[\\p{L}]+[0-9\\-]*[\\p{L}]+[0-9\\-]*";
	        }
	        
	        return regex;
	    }

	    public RegExpTermExtractor(String content) {
	    	this(content, getRegularExpression());
	    }

	    public RegExpTermExtractor(String content, String regexp) {
