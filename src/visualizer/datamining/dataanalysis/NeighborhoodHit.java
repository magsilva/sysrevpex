...
public class NeighborhoodHit extends javax.swing.JDialog {
    ...
    public void display(final ArrayList<Serie> series, final int maxneigh) {
        ...
        Thread t = new Thread() {
            ...
            @Override
            public void run() {
                freechart = createChart(createAllSeries(series, maxneigh));
    ...
    private double[] neighborhoodHit(String filename, int maxneigh) {
        ...
        try {
            ...
            if (filename.toLowerCase().endsWith("xml")) {
                ...
                points = Util.exportProjection(graph, scdata);
            } else if (filename.toLowerCase().endsWith("prj")) {
                points = MatrixFactory.getInstance(filename);
            } else {
            ...
            for (int n = 0; n < maxneigh; n++) {
                ...
                values[n] = percentage / points.getRowCount();
            }
        } catch (IOException ex) {
