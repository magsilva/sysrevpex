...
public class Legend {
    ...
    public void addItem(Legend.Item item) {
        this.items.add(item);
    }
    ...
    public Legend.Item getItem(int index) {
    ...
    public class Item {
        ...
        public Color getColor() {
            if (Legend.this.max > Legend.this.min) {
                return Legend.this.table.getColor((this.value - Legend.this.min) /
                        (Legend.this.max - Legend.this.min));
            } else {
